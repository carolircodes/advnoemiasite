...
// https://advnoemia.com.br/api/whatsapp/webhook
//
// NÃO ALTERE ESTE ARQUIVO - USE apps/portal-backend/app/api/whatsapp/webhook/route.ts

import { NextRequest, NextResponse } from "next/server";

export async function GET() {
  return new Response("WEBHOOK DESATIVADO - Usar apps/portal-backend/app/api/whatsapp/webhook/route.ts", { 
    status: 410 
  });
}
