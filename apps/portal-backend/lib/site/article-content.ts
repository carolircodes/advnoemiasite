...
const ARTICLES: ArticleEntry[] = [
  ...
  },
  {
    ...
    excerpt:
      "Quando uma das partes descumpre o que foi combinado, agir no impulso pode piorar o problema. Clareza juridica evita ruído.",
    topic: "civil",
    categoryLabel: "Civil",
  ...
  },
  {
    ...
    excerpt:
      "Filhos, patrimonio e rotina pedem leitura cuidadosa. O divorcio começa melhor quando o contexto e organizado logo no inicio.",
    topic: "familia",
